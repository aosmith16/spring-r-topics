...
<br/>
Provide a final dataset; the person helping you should not have to run a bunch of code to create the dataset your are using. (*More on datasets coming up.*)
...
Let's practice making a reprex with different code so we explore a couple more options.
