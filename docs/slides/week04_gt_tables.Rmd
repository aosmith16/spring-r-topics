...
You pass in a **gt** object to the `data` argument and then set the file name in `filename`. If you want to save a table somewhere outside your working directory set the path with `path`.
