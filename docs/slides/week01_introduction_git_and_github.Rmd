...
Once you start working with Git regularly, entering your GitHub credentials when you want to push becomes a pain.  I think one way to avoid this is to add a SSH key.
