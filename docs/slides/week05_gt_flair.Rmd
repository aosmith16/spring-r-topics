...
You will need to provide a path to the image. This could be as simple as providing the name of the image (e.g., `"myimage.png"`) or writing out a longer directory path (e.g., `"path/to/image/myimage.png"`).
