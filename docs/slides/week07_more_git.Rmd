...
Some of the easiest examples to find of good README files is for R packages, such as on the [palmerpenguins](https://github.com/allisonhorst/palmerpenguins) repository. 

Follow the link and scroll down to look through the README file there.

--

<br/>
But plenty of people use repositories for other types of work. Here are two examples of non-R package repositories with information-filled README files:
...
.pull-left[
After saving, you'll see in the right-hand side of the GitKraken window that final version of the `README.md` file has been staged.
...
Once you create the PAT you will see a page with the token code visible. Once you leave this page you won't be able to see it again.
...
For this exercise, name your branch with your last name plus "prac". Here I named mine `muldoonprac`; names yours based on your own last name. `r emo::ji("wink")`
