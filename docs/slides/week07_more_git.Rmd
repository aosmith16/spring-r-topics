...
We will switch to GitKraken to make use their merge conflict tool.
...
We will be working on someone else's repository, but using pull requests is a reasonable way to work with collaborators on a shared repository to avoid merge conflicts. One difference from the process shown here will be that you won't need to *fork* a repository you already own.
