...
- We'll explore a few packages for making interactive plots and tables that can be used with HTML outputs  
- Make sure you have current versions of **plotly**, **leaflet**, **dygraphs**, and **reactable** installed  
