...
In Windows the most straightforward thing to do is to use Git Bash (this should already by open).
...
- Find an image you want to represent yourself on your personal website
