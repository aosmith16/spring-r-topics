...
- We'll go through my attempts to provide a reproducible example, with you copying code I provide in the slides and running it in a clean R session
...
<br/>
Provide a final dataset; the person helping you should not have to run a bunch of code to create it. (*More on datasets coming up.*)
