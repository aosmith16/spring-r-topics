...
## Week 8: Using interactive elements in static HTML documents
...
We are exploring a variety of packages this week. Make sure you have current versions of: **htmlwidgets**, **palmerpenguins**, **ggplot2**, **plotly**, **DT**, **leaflet**, **dygraph**, **flexdashboard**

[Week 08 slides](slides/week08_interactive_elements.html)  
Save [`week08_interactivity.Rmd`](files/week08_interaction.Rmd) to knit to HTML output during the session  

## Week 9: Reproducible examples with **reprex**  

### Goals

The ultimate goal this week is to understand how to make a reproducible example or *reprex* when asking a question or reporting an issue. 
...
We will be practice making reproducible examples with package **reprex**. Makes sure you have the current version of **reprex** and **datapasta** installed.

pWeek 09 slides in progress](slides/week09_reprex.html) 
...
We will be practice making reproducible examples with package **reprex**. Makes sure you have the current version of **reprex** installed.

Week 10 slides go here
