...
## Week 9: GitHub issues and reproducible examples with **reprex**  

### Goals

The ultimate goal this week is to understand how to make a reproducible example or *reprex* when asking a question or reporting an issue. We will first talk about some of the etiquette of reporting an issue for R packages on GitHub.
