...
This week we will explore a handful of packages based on **htmlwidgets** for adding interactive elements to static HTML documents. We will finish by looking at how to combine interactive elements into basic dashboard with **flexdashboard**. 
...
## Week 9: Animating plots with **gganimate**
